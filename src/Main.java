...
//        from the user
        ...
        long numberOfPayments = (long) years * MONTHS_IN_A_YEAR; // years times months
        /*
output
...
*/
        ...
        double expectedMonthlyPaymentAmount = principalAmount * ((monthlyInterestRate * Math.pow((1 + monthlyInterestRate), numberOfPayments) / (Math.pow((1 + monthlyInterestRate), numberOfPayments) - 1)));
